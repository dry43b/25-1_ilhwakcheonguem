    ...
    <div>
            ...
            <div className="container mx-auto px-4">
                <div className="rounded-xl border bg-white shadow max-w-2xl mx-auto">
                    <div className="px-6 py-4 border-b">
                        <h2 className="text-xl font-bold">1. MetaMask 다운로드</h2>
                    </div>
        ...
        <section className="w-full py-12 bg-gray-100">
            <div className="container mx-auto px-4">
                <div className="rounded-xl border bg-white shadow max-w-2xl mx-auto">
                    <div className="px-6 py-4 border-b">
                        <h2 className="text-xl font-bold">2. 브라우저 확장 프로그램 설치</h2>
                    </div>
                    <div className="px-6 py-4">
        ...
        <section className="w-full bg-white py-12">
            <div className="container mx-auto px-4">
                <div className="rounded-xl border bg-white shadow max-w-2xl mx-auto">
                    <div className="px-6 py-4 border-b">
                        <h2 className="text-xl font-bold">3. 지갑 생성</h2>
                    </div>
                    <div className="px-6 py-4">
                        <ol className="list-decimal pl-5 space-y-2">
        ...
        <section className="w-full py-12 bg-gray-100">
            <div className="container mx-auto px-4">
                <div className="rounded-xl border bg-white shadow max-w-2xl mx-auto">
                    <div className="px-6 py-4 border-b">
                        <h2 className="text-xl font-bold">4. 설치 완료</h2>
                    </div>
                    <div className="px-6 py-4">
        ...
        <section className="w-full bg-white py-12">
            <div className="container mx-auto px-4">
                <div className="rounded-xl border bg-white shadow max-w-2xl mx-auto">
                    <div className="px-6 py-4 border-b">
                        <h2 className="text-xl font-bold">5. 이용방법</h2>
                    </div>
                    <div className="px-6 py-4">
                        <ol className="list-decimal pl-5 space-y-2">
